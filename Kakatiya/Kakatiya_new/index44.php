            ...
            <div class="row g-4 justify-content-center">
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="project-card">
                        <img src="https://picsum.photos/seed/project1/200/200.jpg" alt="Project 1">
                        <div class="project-logo-center">
                            <img src="https://picsum.photos/seed/logo1/40/40.jpg" alt="Logo">
                        </div>
                        <div class="project-overlay">
                            <h4 class="project-name">E-commerce Platform</h4>
                            <p class="project-description">Modern online shopping experience</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="project-card">
                        <img src="https://picsum.photos/seed/project2/200/200.jpg" alt="Project 2">
                        <div class="project-logo-center">
                            <img src="https://picsum.photos/seed/logo2/40/40.jpg" alt="Logo">
                        </div>
                        <div class="project-overlay">
                            <h4 class="project-name">Mobile Banking App</h4>
                            <p class="project-description">Secure financial transactions</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="project-card">
                        <img src="https://picsum.photos/seed/project3/200/200.jpg" alt="Project 3">
                        <div class="project-logo-center">
                            <img src="https://picsum.photos/seed/logo3/40/40.jpg" alt="Logo">
                        </div>
                        <div class="project-overlay">
                            <h4 class="project-name">Healthcare Portal</h4>
                            <p class="project-description">Patient management system</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="project-card">
                        <img src="https://picsum.photos/seed/project4/200/200.jpg" alt="Project 4">
                        <div class="project-logo-center">
                            <img src="https://picsum.photos/seed/logo4/40/40.jpg" alt="Logo">
                        </div>
                        <div class="project-overlay">
                            <h4 class="project-name">Education Platform</h4>
                            <p class="project-description">Interactive learning experience</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="project-card">
                        <img src="https://picsum.photos/seed/project5/200/200.jpg" alt="Project 5">
                        <div class="project-logo-center">
                            <img src="https://picsum.photos/seed/logo5/40/40.jpg" alt="Logo">
                        </div>
                        <div class="project-overlay">
                            <h4 class="project-name">Real Estate App</h4>
                            <p class="project-description">Property listing platform</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="project-card">
                        <img src="https://picsum.photos/seed/project6/200/200.jpg" alt="Project 6">
                        <div class="project-logo-center">
                            <img src="https://picsum.photos/seed/logo6/40/40.jpg" alt="Logo">
                        </div>
                        <div class="project-overlay">
                            <h4 class="project-name">Travel Booking System</h4>
                            <p class="project-description">Seamless travel planning</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="project-card">
                        <img src="https://picsum.photos/seed/project7/200/200.jpg" alt="Project 7">
                        <div class="project-logo-center">
                            <img src="https://picsum.photos/seed/logo7/40/40.jpg" alt="Logo">
                        </div>
                        <div class="project-overlay">
                            <h4 class="project-name">IoT Dashboard</h4>
                            <p class="project-description">Smart device management</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-md-4 col-lg-3">
                    <div class="project-card">
                        <img src="https://picsum.photos/seed/project8/200/200.jpg" alt="Project 8">
                        <div class="project-logo-center">
                            <img src="https://picsum.photos/seed/logo8/40/40.jpg" alt="Logo">
                        </div>
                        <div class="project-overlay">
                            <h4 class="project-name">Social Media Platform</h4>
                            <p class="project-description">Community engagement tool</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                            <div class="footer-logo">
                                <img src="https://picsum.photos/seed/logo/200/60.jpg" alt="Company Logo">
                            </div>
