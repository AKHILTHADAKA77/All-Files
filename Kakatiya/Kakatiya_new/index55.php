...
<?php include('header_links.php');?>
   <style>
        ...
        .project-showcase-overlay {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(to bottom, rgba(11, 17, 32, 0.2), rgba(11, 17, 32, 0.8));
            display: flex;
        ...
        .tech-tag:hover {
            background: rgba(79, 159, 255, 0.25);
            color: #e9eefc;
        }
        ...
        .project-showcase-link i {
            margin-left: 5px;
            transition: transform 0.2s ease;
        }
        
        .project-showcase-link:hover i {
        ...
        @media (min-width: 992px) {
            ...
            .featured-project .project-showcase-image {
                width: 50%;
                height: 100%;
            }
            
            .featured-project .project-showcase-content {
                width: 50%;
                padding: 40px;
                display: flex;
                flex-direction: column;
            ...
            <div class="projects-showcase">
                ...
                <div class="featured-project">
                    <div class="project-showcase-image">
                        <img src="https://picsum.photos/seed/featured/800/400.jpg" alt="Featured Project">
                    ...
                    <div class="project-showcase-content">
                        <h3 class="project-showcase-title">Enterprise E-commerce Platform</h3>
                        <p class="project-showcase-description">A comprehensive e-commerce solution built for a multinational retail company, handling over 10,000 transactions daily with advanced analytics and inventory management.</p>
                        <div class="project-tech-tags">
                            <span class="tech-tag">React</span>
                            <span class="tech-tag">Node.js</span>
                            <span class="tech-tag">MongoDB</span>
                        ...
                        <a href="#" class="project-showcase-link">View Case Study <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="project-showcase-item">
                            <div class="project-showcase-image">
                                <img src="https://picsum.photos/seed/project1/400/250.jpg" alt="Project 1">
                                <div class="project-showcase-overlay">
                                    <div class="project-tech-tags">
                            ...
                            <div class="project-showcase-content">
                                <h3 class="project-showcase-title">Healthcare Management System</h3>
                                <p class="project-showcase-description">A comprehensive patient management system for a network of hospitals.</p>
                                <div class="project-tech-tags">
                                    <span class="tech-tag">Vue.js</span>
                                    <span class="tech-tag">Laravel</span>
                                    <span class="tech-tag">MySQL</span>
                                </div>
                                <a href="#" class="project-showcase-link">View Details <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="project-showcase-item">
                            <div class="project-showcase-image">
                                <img src="https://picsum.photos/seed/project2/400/250.jpg" alt="Project 2">
                                <div class="project-showcase-overlay">
                                    <div class="project-tech-tags">
                            ...
                            <div class="project-showcase-content">
                                <h3 class="project-showcase-title">FinTech Mobile App</h3>
                                <p class="project-showcase-description">Secure mobile banking application with biometric authentication.</p>
                                <div class="project-tech-tags">
                                    <span class="tech-tag">React Native</span>
                                    <span class="tech-tag">Firebase</span>
                                </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="project-showcase-item">
                            <div class="project-showcase-image">
                                <img src="https://picsum.photos/seed/project3/400/250.jpg" alt="Project 3">
                                <div class="project-showcase-overlay">
                                    <div class="project-tech-tags">
                            ...
                            <div class="project-showcase-content">
                                <h3 class="project-showcase-title">IoT Dashboard</h3>
                                <p class="project-showcase-description">Real-time monitoring dashboard for industrial IoT devices.</p>
                                <div class="project-tech-tags">
                                    <span class="tech-tag">Angular</span>
                                    <span class="tech-tag">.NET Core</span>
                                    <span class="tech-tag">Azure</span>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="project-showcase-item">
                            <div class="project-showcase-image">
                                <img src="https://picsum.photos/seed/project4/400/250.jpg" alt="Project 4">
                                <div class="project-showcase-overlay">
                                    <div class="project-tech-tags">
                            ...
                            <div class="project-showcase-content">
                                <h3 class="project-showcase-title">Education Platform</h3>
                                <p class="project-showcase-description">Interactive learning platform with video streaming and assessments.</p>
                                <div class="project-tech-tags">
                                    <span class="tech-tag">Next.js</span>
                                    <span class="tech-tag">GraphQL</span>
                                    <span class="tech-tag">PostgreSQL</span>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="project-showcase-item">
                            <div class="project-showcase-image">
                                <img src="https://picsum.photos/seed/project5/400/250.jpg" alt="Project 5">
                                <div class="project-showcase-overlay">
                                    <div class="project-tech-tags">
                            ...
                            <div class="project-showcase-content">
                                <h3 class="project-showcase-title">Travel Booking App</h3>
                                <p class="project-showcase-description">Cross-platform app for booking flights, hotels, and activities.</p>
                                <div class="project-tech-tags">
                                    <span class="tech-tag">Flutter</span>
                                    <span class="tech-tag">Django</span>
                                </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="project-showcase-item">
                            <div class="project-showcase-image">
                                <img src="https://picsum.photos/seed/project6/400/250.jpg" alt="Project 6">
                                <div class="project-showcase-overlay">
                                    <div class="project-tech-tags">
                                        <span class="tech-tag">React</span>
                            ...
                            <div class="project-showcase-content">
                                <h3 class="project-showcase-title">Social Media Analytics</h3>
                                <p class="project-showcase-description">Analytics platform for social media performance tracking.</p>
                                <div class="project-tech-tags">
                                    <span class="tech-tag">React</span>
                                    <span class="tech-tag">Express</span>
                                    <span class="tech-tag">Redis</span>
            ...
            <div class="row">
                <div class="col-12 col-lg-4 mb-4 mb-lg-0">
                    <div class="footer-logo">
                        <img src="https://picsum.photos/seed/companylogo/200/60.jpg" alt="Company Logo">
                    </div>
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="map-container">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d387190.2799160891!2d-74.25987368715491!3d40.69767006416587!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1s0x0%3A0x0!2zNDDCsDQxJzUxLjYiTiA3NMKwMTUnMzUuNCJX!5e0!3m2!1sen!2sus!4v1629886789422!5m2!1sen!2sus" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                </div>
            </div>
            <div class="copyright">
